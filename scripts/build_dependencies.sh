...
conda install -c intel conda==23.5.2 mkl mkl-devel mkl-static mkl-include -y
conda install -c pytorch -c nvidia conda==23.5.2 pytorch torchvision torchaudio pytorch-cuda=11.8 -y
conda install -c pyg conda==23.5.2 pyg h5py -y
#conda install -c conda-forge faiss-gpu -y
pip install numba PyMCubes pytorch-lightning hydra-core shapely scikit-image matplotlib tensorboard plyfile opencv-python opencv-contrib-python open3d ray[default]
