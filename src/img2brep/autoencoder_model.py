...
# Full continuous VAE with intersection
class AutoEncoder_inter_encoder(AutoEncoder_base):
    def __init__(self,
                 v_conf,
                 ):
        super().__init__(v_conf)
    ...
    def forward(self, v_data,
        ...
        edge_index = encoder_result["edge_face_connectivity"][..., 0]
        vertex_index = encoder_result["vertex_edge_connectivity"][..., 0]
