...
class Collision_checker:
    ...
    def check_ray(self, v_origin, v_direction):
        if self.triangles is None:
            ...
            final_flag = torch.ones((v_origin.shape[0],self.triangles.shape[0]), dtype=torch.bool, device=v_origin.device)
            ...
            # Check parallel
            final_flag[torch.abs(det) < 1e8] = 0
            ...
            final_flag[t<0] = 0
            final_flag[t>original_distance-1e8] = 0
