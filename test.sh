...
#             echo ${ADDR[-1]}
             scp -P 12222 -r "/d/Projects/Reconstructability/training_data/v2/"${ADDR[-1]}"/training_data" "root@172.31.224.143:/mnt/d/reconstructability/v2/"${ADDR[-1]}"/training_data"
